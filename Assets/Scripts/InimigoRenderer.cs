...
namespace Assets.scripts
{
    ...
    public class InimigoRenderer : MonoBehaviour
    {
        ...
        public void SetDirection(Vector2 direction)
        {
            ...
            target = GameObject.FindGameObjectWithTag("Player").GetComponent<Vector2>();

            //measure the magnitude of the input.
            if (target.magnitude < .01f)
            {
            ...
            else
            {
                ...
                lastDirection = DirectionToIndex(target, 8);
            }
