...
{
    //https://github.com/ribbybibby/Unity-Learn/blob/master/SwitchBlade/Scripts/EnemyMovement.cs
    public float speed;
    ...
    void Update()
    {
        transform.Rotate(360, 360, 0);
        transform.position = Vector2.MoveTowards(transform.position, target.position, speed * Time.deltaTime);
        SetDirection(Vector2.MoveTowards(target.position, target.position, speed * Time.deltaTime));
    }
